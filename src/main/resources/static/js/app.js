    ...
    var verEventos = function (json) {
        ...
        for (var i in json) {
            ...
            var s = "<div class='col-lg-3 col-md-6 mb-4 mb-lg-0'  >" +
                ...
                "<div class='card-body p-4'  style='width:100%;color:#290f68; background-color: rgba(0, 255, 213, 0.397);'>" +
                "<img src='img/sub.png' alt='' class='img-fluid d-block mx-auto mb-3'>" +
                "<h5 class='card-title'>" + name + "</h5>" +
                "<p class='small text-muted font-italic'>" + description + "</p>" +
                "<input onclick=\"window.location='./subasta.html?value=" + id + "';\"  type='button' value='ingresar' style='margin-left: auto; margin-right: auto;'>" +
                "</div>" +
                "</div>" +
                "</div>";
